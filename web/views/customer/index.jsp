<%@ page import="com.hsp.furns.entity.Furn" %>
<%@ page import="com.hsp.furns.entity.Page" %>
<%@ page import="com.hsp.furns.service.FurnService" %>
<%@ page import="com.hsp.furns.service.impl.FurnServiceImpl" %>
...
<%
 FurnService furnService = new FurnServiceImpl();
    Page<Furn> pageshouye = furnService.page(1, 4);
    //application保存有几页   有几条记录

pageContext.setAttribute("pageshouye",pageshouye);
pageContext.setAttribute("pageTotalCountshouye",pageshouye.getPageTotalCount());


    pageContext.setAttribute("totalRowshouye",pageshouye.getTotalRow());

    pageContext.setAttribute("itemsshouye",pageshouye.getItems());
%>
            ...
            <div class="row align-self-center">
                ...
                <div class="col align-self-center">
                    <div class="header-actions">
                        <div class="header_account_list">
                            ...
                            <div class="dropdown_search">
                                <form class="action-form" action="customerFurnServlet">
                                    ...
                                    <input class="form-control" placeholder="Enter your search key" type="text" name="search" value="${requestScope.search}">
                        ...
                        <c:choose>
                            <c:when test="${sessionScope.isLogin>0}">
                                <div class="header-bottom-set dropdown">
                                    <a>欢迎:${sessionScope.loginUsername}</a>
                                </div>
                            </c:when>
                            <c:otherwise>
                                <div class="header-bottom-set dropdown">
                        ...
                        <c:choose>
                            ...
                            <c:otherwise>
                                <div class="header-bottom-set dropdown">
                                    <a href="/jiaju_mall/views/manager/manage_login.jsp">后台管理</a>
                                </div>
                            </c:otherwise>
                        </c:choose>
...
<%--首页导航条--%>
<c:if test="${requestScope.navigationPage > 10}">
...
<!--        <li><a>共90记录</a></li>-->
        ...
        <li><a href="customerFurnServlet?action=page&pageNo=1&pageSize=4">首页</a></li>

        <%--                如果当前页>1，就显示上一页--%>
        <c:if test="${requestScope.page.pageNo>1}">
            <li><a href="customerFurnServlet?action=page&pageNo=${requestScope.page.pageNo-1}">上页</a></li>
        </c:if>
        <%--        <li><a>当前第${requestScope.page.pageNo}页</a></li>--%>
        ...
        <c:if test="${(requestScope.page.pageNo+2)<=requestScope.page.pageTotalCount}">
...
<%--        &lt;%&ndash;        <li><a>当前第${requestScope.page.pageNo}页</a></li>&ndash;%&gt;--%>

<%--        <c:forEach begin="1" end="${pageScope.pageTotalCountshouye}" step="1" var="i">--%>

<%--            &lt;%&ndash;            <li><a>当前第${i}页</a></li>&ndash;%&gt;--%>
<%--            <li><a href="customerFurnServlet?action=page&pageNo=${i}&pageSize=4">${i}</a></li>--%>

<%--        </c:forEach>--%>

<%--        <li><a href="customerFurnServlet?action=page&pageNo=${requestScope.page.pageNo+1}&pageSize=4">下页</a></li>--%>

<%--        <li><a>共${pageScope.pageTotalCountshouye}页</a></li>--%>
<%--        <li><a>共${pageScope.totalRowshouye}记录</a></li>--%>
...
<c:if test="${requestScope.navigationPage < 10}">
    ...
    <div class="pro-pagination-style text-center mb-md-30px mb-lm-30px mt-6" data-aos="fade-up">
        <ul>
            ...
            <li><a href="customerFurnServlet?action=pageByName&pageNo=1&pageSize=4&search=${requestScope.search}">首页</a></li>

                <%--                如果当前页>1，就显示上一页--%>
            <c:if test="${requestScope.page.pageNo>1}">
                <li><a href="customerFurnServlet?action=pageByName&pageNo=${requestScope.page.pageNo-1}&search=${requestScope.search}">上页</a></li>
            </c:if>
                <%--        <li><a>当前第${requestScope.page.pageNo}页</a></li>--%>
            <c:if test="${(requestScope.page.pageNo-2)>0}">
                <c:set var="begin" value="${requestScope.page.pageNo-2}"/>
            ...
            <c:forEach begin="${begin}" end="${end}" step="1" var="i">
                ...
                <%--            <li><a>${i}</a></li>--%>
                <c:if test="${i == requestScope.page.pageNo}">
                    <li><a class="active" href="customerFurnServlet?action=pageByName&pageNo=${i}&search=${requestScope.search}">${i}</a></li>
                </c:if>

                <c:if test="${i != requestScope.page.pageNo}">
                    <li><a href="customerFurnServlet?action=pageByName&pageNo=${i}&search=${requestScope.search}">${i}</a></li>
                </c:if>
            </c:forEach>

                <%--                如果当前页<总页数，就显示下一页--%>
            <c:if test="${requestScope.page.pageNo<requestScope.page.pageTotalCount}">
                <li><a href="customerFurnServlet?action=pageByName&pageNo=${requestScope.page.pageNo+1}&search=${requestScope.search}">下页</a></li>
            </c:if>
